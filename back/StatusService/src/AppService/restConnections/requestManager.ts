...
const url_DiscoveryRep = services.DiscoveryRep.protocol + '://' + services.DiscoveryRep.host + ':' + services.DiscoveryRep.port;
...
export class RequestManager {
    ...
    public static requestToDiscoveryRep = (path: string, bodyObj: Object): Promise<ASYNC_RESPONSE> => {
        return RequestManager.sendRestRequest(url_DiscoveryRep, path, bodyObj, timeout_AV);
    };
